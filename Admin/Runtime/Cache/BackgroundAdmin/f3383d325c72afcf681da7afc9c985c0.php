...
<body>
<form action="<?php echo U('/BackgroundAdmin/Index/auditscore');?>" method="post">
<div id="gallery">
...
<a class="detail1" href="<?php echo U('/BackgroundAdmin/Index/queryclass',array('pclass_id'=>$pclassid,'grade_id'=>$grade_id));?>" style="margin-left:5px;">返回</a>
</form>
</body>
</html>