		...
		<div id="left_box">
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Index/querygrade');?>" class="pos">测评审核</a>				        	
				        </li> 
				    </ul>
				</div>
			</div>
			 ...
			 <div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Class/querygrade');?>" class="pos">班级管理</a>				        	
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Class/querygradeclass');?>" class="pos">导入学生账号</a>				        	
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Class/querygradeinput');?>" class="pos">导入学生测评信息</a>				        	
				        </li> 
				    </ul>
				 <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Class/querygradeexpect');?>" class="pos">导出测评结果</a>				        	
				        </li> 
				    </ul>
				</div>
			</div>	
			<div class="menu_box">
				...
				<div class="text">
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Admin/schoolyear');?>" class="pos">设置当前学年</a>				        	
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Admin/grade');?>" class="pos">年级管理</a>				        	
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('BackgroundAdmin/Admin/instructor');?>" class="pos">辅导员管理</a>				        	
				        </li> 
				    </ul>
					<ul class="con">
				        <li class="nav_u">
